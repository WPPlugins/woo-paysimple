 ...
 */
	public function createCustomer($data) {
		...
		'StreetAddress1' => isset($_POST['billing_address_1']) ? $_POST['billing_address_1'] : '' ,
		'StreetAddress2' => isset($_POST['billing_address_2']) ? $_POST['billing_address_2'] : '' ,
		'City' => isset($_POST['billing_city']) ? $_POST['billing_city'] : '' ,
		'Country' => isset($_POST['billing_country']) ? $_POST['billing_country'] : '',
		'StateCode' => isset($_POST['billing_state']) ? $_POST['billing_state'] : '',
		'ZipCode' => isset($_POST['billing_postcode']) ? $_POST['billing_postcode'] : '',
		),
		...
		if (isset($_POST['ship_to_different_address']) && !empty($_POST['ship_to_different_address'])) {
			...
			'StreetAddress1' => isset($_POST['shipping_address_1']) ? $_POST['shipping_address_1'] : '' ,
			'StreetAddress2' =>isset($_POST['shipping_address_2']) ? $_POST['shipping_address_2'] : '' ,
			'City' => isset($_POST['shipping_city']) ? $_POST['shipping_city'] : '' ,
			'StateCode' => isset($_POST['shipping_state']) ? $_POST['shipping_state'] : '',
			'ZipCode' => isset($_POST['shipping_postcode']) ? $_POST['shipping_postcode'] : '0',
			);
		}
   ...
   */
	public function _sendRequest($method, $action, $data = NULL) {
		...
		$paysimple_username = $mode == 'no' ?  $conf_settings['paysimple_username'] :  $conf_settings['sandbox_paysimple_username'];
		$paysimple_sharedsecret = $mode == 'no' ?  $conf_settings['paysimple_sharedsecret'] : $conf_settings['sandbox_paysimple_sharedsecret'];
		if ($mode == 'yes') {
   ...
   */
	public function addCreditCardAccount($data, $IsDefault = false) {
		...
		'ExpirationDate' => $data['card_exp_month'] . '/' . $data['card_exp_year'],
		'CustomerId' => $data['paysimple_customer_id'],
